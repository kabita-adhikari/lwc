...
circuit. The process of converting between the two representations is quite mechanical: simply use the substitutions above, being sure to parenthesize Boolean expressions in a manner that preserves which operators go with which operands.

::: {.callout-important title="Activity " collapse="true" icon=false}
Try to write the Boolean expression corresponding to the following circuit :

![](images\img5 (22).png){ width=550px }
:::
